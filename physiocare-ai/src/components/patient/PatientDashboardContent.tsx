...
const exercises = [
  { name: "Shoulder Flexion", reps: "3×12", status: "pending", intensity: "Medium" },
  { name: "Elbow Extension", reps: "3×10", status: "completed", intensity: "Hard" },
  { name: "Wrist Rotation", reps: "2×15", status: "pending", intensity: "Light" },
  { name: "Grip Strength", reps: "3×8", status: "completed", intensity: "Hard" },
];
...
export default function PatientDashboardContent() {
  ...
  const completedToday = exercises.filter(e => e.status === "completed").length;
        ...
        <StaggerContainer className="space-y-8">
          ...
          <StaggerItem>
            <motion.div
              ...
              className="glass-card p-8 md:p-10 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-transparent overflow-hidden relative"
            >
          ...
          <div className="grid grid-cols-12 gap-6">
                  ...
                  <div className="space-y-3">
                    {availableDoctors.slice(0, 3).map((doctor: any, idx: number) => (
                      <motion.div
                        ...
                        className="group rounded-xl border border-white/8 bg-gradient-to-r from-slate-800/50 to-slate-900/50 hover:from-slate-800/80 hover:to-slate-900/80 p-4 transition-all hover:border-white/12"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4 min-w-0">
                            <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center text-white font-bold text-sm shrink-0">
            ...
            <StaggerItem className="col-span-12 lg:col-span-4">
              <div className="glass-card p-7 bg-gradient-to-br from-blue-500/10 to-cyan-500/5">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-lg font-semibold text-foreground">Shoulder Mobility</p>
                  </div>
                  ...
                  <div className="rounded-lg bg-white/5 border border-white/8 p-3">
                    ...
                    <p className="text-sm text-foreground">5 exercises · ~15 minutes</p>
                  </div>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="w-16 h-16 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-cyan-400">{Math.round((completedToday / exercises.length) * 100)}%</p>
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0 flex-1">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{ex.reps} • {ex.intensity} intensity</p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                return (
                  ...
                  >
                    <Link href={cta.href}>
                      <div className={`glass-card p-6 bg-gradient-to-br ${cta.color} bg-opacity-5 border border-white/8 hover:border-white/12 group cursor-pointer`}>
                        <div className="flex items-start justify-between mb-4">
                          <div>
                          ...
                          <div className={`p-3 rounded-xl bg-gradient-to-br ${cta.color} bg-opacity-20 group-hover:bg-opacity-30 transition-all`}>
